...
{
	sensor_info.mode[STM_TRANS].mode_corner_light.mode_value = CORNER_LIGHT_MODE_OFF;
...
void set_corner_light_beam()
{
	...
	{ // 좌회전
		sensor_info.mode[STM_TRANS].mode_corner_light.mode_value = CORNER_LIGHT_MODE_LEFT;
	}
	else if (tmp > corner_threshold_right)
	{ // 우회전
		sensor_info.mode[STM_TRANS].mode_corner_light.mode_value = CORNER_LIGHT_MODE_RIGHT;
	}
	else
	{ // 직진
		sensor_info.mode[STM_TRANS].mode_corner_light.mode_value = CORNER_LIGHT_MODE_OFF;
